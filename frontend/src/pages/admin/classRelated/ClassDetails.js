...
const ClassDetails = () => {
    ...
    const subjectActions = [
        {
            icon: <PostAddIcon color="primary" />, name: 'Add New Segment',
            action: () => navigate("/Admin/addsubject/" + classID)
        },
        {
            icon: <DeleteIcon color="error" />, name: 'Delete All Segments',
    ...
    const ClassDetailsSection = () => {
        ...
        return (
            <>
                ...
                <Typography variant="h5" gutterBottom>
                    Project Name: {sclassDetails && sclassDetails.sclassName}
                </Typography>
                <Typography variant="h6" gutterBottom>
                    Number of Project Segmentations: {numberOfSubjects}
                </Typography>
                <Typography variant="h6" gutterBottom>
                        ...
                        <TabContext value={value}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <TabList onChange={handleChange} sx={{ position: 'fixed', width: '100%', bgcolor: 'background.paper', zIndex: 1 }}>
                                    ...
                                    <Tab label="Segmentations" value="2" />
